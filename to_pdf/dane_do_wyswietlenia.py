dane_do_wyswietlenia={'Witamina A':['gramy_roztworu','krople','jednostki','gestosc','opakowania','mililitry'],'Metronidazol':['gramy'],
                      "Oleum Cacao":['gramy']
                      ,'Hydrokortyzon':['gramy'],
                      'Wazelina':['gramy'],
                      'Etanol': ['gramy', 'uzyte_stezenie', 'pozadane_stezenie', 'ilosc_etanolu',
                    'ilosc_wody_do_etanolu'],
